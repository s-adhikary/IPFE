...
static const uint64_t SIFE_CRT_CONSTS[SIFE_NMODULI]= {0, 903170, 1362091, 26843455}; 
static const uint32_t SIFE_MOD_Q_I[SIFE_NMODULI] = {114689, 1032193, 7340033, 33538049}; 
static const uint32_t SIFE_MOD_QINV_I[SIFE_NMODULI] ={268320769, 267403265, 4287627265, 234897409}; 
static const uint32_t INT64_MOD_Q[SIFE_NMODULI] = {2484, 765937, 3338324, 671696}; 
...
static const char SIFE_P_str[] = "4097"; 
static const char SIFE_SCALE_M_str[]="7112995254524274163376";  
static const uint64_t SIFE_SCALE_M_MOD_Q_I[SIFE_NMODULI]= {8146, 641184, 4249587, 14767547}; 
extern uint32_t qdata[SIFE_NMODULI][4];
