...
{
	// Declarate variables
	uint32_t mpk[SIFE_L+1][SIFE_NMODULI][SIFE_N] __attribute__((aligned(32)));
	uint32_t msk[SIFE_L][SIFE_NMODULI][SIFE_N] __attribute__((aligned(32)));
	uint32_t c[SIFE_L+1][SIFE_NMODULI][SIFE_N] __attribute__((aligned(32)));
	uint32_t sk_y[SIFE_NMODULI][SIFE_N] __attribute__((aligned(32)));
	//uint32_t d_y[SIFE_NMODULI][SIFE_N];

	uint32_t m[SIFE_L] __attribute__((aligned(32)));
	uint32_t y[SIFE_L] __attribute__((aligned(32)));
...
int test_rlwe_sife_mat_vec()			/*Only matrix-vector multiplication*/
{
	...
	uint32_t m[SIFE_L][SIFE_N] __attribute__((aligned(32)));
	uint32_t y[SIFE_L] __attribute__((aligned(32)));
	uint32_t res_vec[SIFE_N] __attribute__((aligned(32)));
